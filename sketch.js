...
var r1_d_open, r1_d2_open, r2_d_open, r3_d_open, r4_d_open, r5_d_open, r6_ld_open, r6_rd_open, md_open, stairs_d_open, lab_stairs_d_open;
...
function preload() {
  ...
  vialImg = loadImage("Images/Chemical vial.png");
  skeyImg = loadImage("Images/Silver key.png");
  mainkeyImg = loadImage("Images/Golden key.png");
}
  ...
  if (gameState === 2) {
    ...
    for (var plr in allPlayers) {
      ...
      if (index === player.index) {
        if (player.index === 1) {
          if (p1_sr.isTouching(r1_d) || p1_sr.isTouching(r1_d2) || p1_sr.isTouching(r2_d) || p1_sr.isTouching(r3_d) || p1_sr.isTouching(r4_d) || p1_sr.isTouching(r5_d) || p1_sr.isTouching(r6_ld) || p1_sr.isTouching(r6_rd) || p1_sr.isTouching(stairs_d) || p1_sr.isTouching(lab_stairs_d)) {
            ...
            if (p1_sr.isTouching(stairs_d)) {
              if (stairs_d_open === false)
                text("Press 'Space' to open the door", players[index - 1].x - 70, players[index - 1].y + 50);
              else
                text("Press 'Space' to close the door", players[index - 1].x - 70, players[index - 1].y + 50);

              if (keyCode === 32 && stairs_d_open === false)
                game.updateStairsDStatus(true, -162.5, 486.5, 100, 15);
              else if (keyCode === 32 && stairs_d_open === true)
                game.updateStairsDStatus(false, -212.5, 526, 15, 100);
            }
            if (p1_sr.isTouching(lab_stairs_d)) {
              if (lab_stairs_d_open === false)
                text("Press 'Space' to open the door", players[index - 1].x - 70, players[index - 1].y + 50);
              else
                text("Press 'Space' to close the door", players[index - 1].x - 70, players[index - 1].y + 50);

              if (keyCode === 32 && lab_stairs_d_open === false)
                game.updateLabStairsDStatus(true, 3582.5, 648.5, 100, 15);
              else if (keyCode === 32 && lab_stairs_d_open === true)
                game.updateLabStairsDStatus(false, 3532.5, 606, 15, 100);
            }
          }
        }
          ...
          if (p2_sr.isTouching(r1_d) || p2_sr.isTouching(r1_d2) || p2_sr.isTouching(r2_d) || p2_sr.isTouching(r3_d) || p2_sr.isTouching(r4_d) || p2_sr.isTouching(r5_d) || p2_sr.isTouching(r6_ld) || p2_sr.isTouching(r6_rd) || p2_sr.isTouching(stairs_d) || p2_sr.isTouching(lab_stairs_d) || p2_sr.isTouching(house_md)) {
            ...
            if (p2_sr.isTouching(lab_stairs_d)) {
              if (lab_stairs_d_open === false)
                text("Press 'Space' to open the door", players[index - 1].x - 70, players[index - 1].y + 50);
              else
                text("Press 'Space' to close the door", players[index - 1].x - 70, players[index - 1].y + 50);
          ...
          if (p3_sr.isTouching(r1_d) || p3_sr.isTouching(r1_d2) || p3_sr.isTouching(r2_d) || p3_sr.isTouching(r3_d) || p3_sr.isTouching(r4_d) || p3_sr.isTouching(r5_d) || p3_sr.isTouching(r6_ld) || p3_sr.isTouching(r6_rd) || p3_sr.isTouching(stairs_d) || p3_sr.isTouching(lab_stairs_d) || p3_sr.isTouching(house_md)) {
            ...
            if (p3_sr.isTouching(lab_stairs_d)) {
              if (lab_stairs_d_open === false)
                text("Press 'Space' to open the door", players[index - 1].x - 70, players[index - 1].y + 50);
              else
                text("Press 'Space' to close the door", players[index - 1].x - 70, players[index - 1].y + 50);
          ...
          if (p4_sr.isTouching(r1_d) || p4_sr.isTouching(r1_d2) || p4_sr.isTouching(r2_d) || p4_sr.isTouching(r3_d) || p4_sr.isTouching(r4_d) || p4_sr.isTouching(r5_d) || p4_sr.isTouching(r6_ld) || p4_sr.isTouching(r6_rd) || p4_sr.isTouching(stairs_d) || p4_sr.isTouching(lab_stairs_d) || p4_sr.isTouching(house_md)) {
            ...
            if (p4_sr.isTouching(lab_stairs_d)) {
              if (lab_stairs_d_open === false)
                text("Press 'Space' to open the door", players[index - 1].x - 70, players[index - 1].y + 50);
              else
                text("Press 'Space' to close the door", players[index - 1].x - 70, players[index - 1].y + 50);
